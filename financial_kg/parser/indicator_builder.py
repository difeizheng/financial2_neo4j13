...
def build_indicators(
    ...
    for sheet_name, cell_list in sheet_cells.items():
        ...
        # Inherit headers from previous tables within the same sheet
        from .header_inheritance import inherit_headers_within_sheet
...
def _process_table(
    ...
    table = Table(
        ...
        header_rows=[tbl.header_row, tbl.header_row + 1] if tbl.is_double_header else [tbl.header_row],
